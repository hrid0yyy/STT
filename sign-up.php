...
<head>
  ...
  <title>Sign up | Shelf To Tales</title>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 ">
                            <a href="index.php" class="site-brand">
                                <img class="logo" src="image/logo6.png" alt="">
                            </a>
                        </div>
                        <div class="col-lg-3">
                            <div class="header-phone ">
                                ...
                                <div class="text">
                                    ...
                                    <p class="font-weight-bold number">+880 164 5194 634</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
			...
			<div class="container">
				<div class="breadcrumb-contents">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb" style="margin-bottom:-1rem; padding:15px 0                   ">
...
<section class="auth bg-base d-flex flex-wrap">  
    <div class="auth-left d-lg-block d-none">
        <div class="d-flex align-items-center flex-column h-100 justify-content-center"style="background-color: rgb(255, 255, 255);">
            <img src="assets/images/auth/auth-img.png"style="background-color: rgb(255, 255, 255);"  alt="">
        </div>
    </div>
    ...
    <div class="icon-field mb-16">
        ...
        <input type="text" class="form-control h-56-px bg-neutral-50 radius-12" autocomplete="off" name="user_name" placeholder="Username" required>
    </div>
    <div class="icon-field mb-16">
        <span class="icon top-50 translate-middle-y">
            <iconify-icon icon="mage:email"></iconify-icon>
        </span>
        <input type="email" class="form-control h-56-px bg-neutral-50 radius-12" autocomplete="off" name="email" placeholder="Email" required>
    </div>
    <div class="mb-20">
        <div class="position-relative">
            <div class="icon-field">
                ...
                <input type="password" class="form-control h-56-px bg-neutral-50 radius-12" autocomplete="off" id="your-password" name="password" required placeholder="Password">
            </div>
    ...
    <!-- <div class="">
        ...
        <select id="user-role" name="user_type" class="form-control">
    ...
    <button type="submit" name="signup" class="btn btn-primary text-sm btn-sm px-12 py-16 w-100 radius-12 mt-32"> Sign Up</button>
</form>
...
<script>
	...
	// Redirect when a radio button is clicked
