...
// Fetch borrowing information for the current user
$query = "SELECT books.title, books.bookcover, borrowing.borrow_date, shopowners.shop_name, authors.name AS author_name
          FROM borrowing 
          JOIN books ON borrowing.book_id = books.book_id
          JOIN shopowners ON borrowing.shop_owner_id = shopowners.shop_owner_id
          JOIN authors ON books.author_id = authors.author_id
          WHERE borrowing.reader_id = :user_id";
...
if (isset($_GET['status']) && $_GET['status'] === 'success') {
    ...
    <script>
        // Auto-dismiss the alert after 2 seconds (2000 milliseconds)
        setTimeout(function() {
...
<head>
    ...
    <title>Borrow Books| Shelf To Tales</title>
         ...
         <section id="main-content">
            ...
            <section class="account-context">
                <div class="inner-account-context">
                    <div class="tablist">
                        ...
                        <div class="tabs">
                            ...
                            <div class="tab-divs active">
                                <a href="borrow-books-reader.php" style="color: white;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    <div class="header">
        <span>Borrow Books (<?php echo count($borrowed_books); ?>)</span>
    </div>
    ...
    <table class="borrow-book-list">
        ...
        <?php if (!empty($borrowed_books)): ?>
            <?php foreach ($borrowed_books as $book): 
                // Calculate the time length in days
                $borrow_date = new DateTime($book['borrow_date']);
                $current_date = new DateTime();
                $time_length = $current_date->diff($borrow_date)->days;
            ?>
            <tr>
                <td><img style="width:50px; height:80px;" src="image/book-cover/<?php echo htmlspecialchars($book['bookcover']); ?>" 
                     alt="Book cover image" 
                     onerror="this.onerror=null;this.src='image/book-cover/default.png';"></td>
                <td><?php echo htmlspecialchars($book['title']); ?></td>
                <td><?php echo htmlspecialchars($book['author_name']); ?></td>
                <td><?php echo $time_length; ?> Days</td>
            </tr>
            <?php endforeach; ?>
        <?php else: ?>
            <tr>
