...
<head>
    ...
    <title>Exchange Books | Shelf To Tales</title>
            ...
            <section class="account-context">
                <div class="inner-account-context">
                    <div class="tablist">
                        ...
                        <div class="tabs">
                            <div class="tab-divs ">
                                <a href="account-reader.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            ...
                            <div class="tab-divs active">
                                <a href="exchange-books-reader.php" style="color: white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addProductModalLabel">Add New Book for Exchange</h5>
            ...
            <div class="modal-body">
                <form id="addProductForm" method = "POST">
                    ...
                    <div class="mb-3">
                            <label for="preferred_genre" class="form-label">Preferred Genre</label>
                            <select name="preferred_genre" class="form-control" id="preferred_genre">
                    ...
                    <div class="mb-3">
                        <label for="condition_image" class="form-label">Condition Image (URL)</label>
                        <input type="text" name = "condition_image" class="form-control" id="condition_image">
                    </div>
                    <button type="submit" name="add_book" class="btn btn-primary">Submit</button>
                        ...
                        <?php
// Assuming $reader_id is the current logged-in user's ID
$reader_id = $_SESSION['user_id'];  // Example: using session to get the reader's user ID

// Retrieve the available books for exchange for this user
$available_books = getAvailableBooksForExchangeByUser($reader_id, $conn);
    ...
    <?php if (!empty($available_books)): ?>
        <?php foreach ($available_books as $book):
           ?>
            <tr>
                <td>
                    <?php $cover = "image/book-cover/".htmlspecialchars($book['bookcover']); ?>
                    <!-- Show the book's condition image if available, otherwise a default image -->
                    <img src="<?php echo $cover; ?>" alt="Book Cover" style="width: 2.9375rem;">
                </td>
                <td><?php echo htmlspecialchars($book['title']); ?></td>
                <td><?php echo htmlspecialchars($book['preferred_genre']); ?></td>
            </tr>
        <?php endforeach; ?>
    <?php else: ?>
        <tr>
            <td colspan="3">No books available for exchange.</td>
        </tr>
    <?php endif; ?>
</table>
<br>
                <!--   exchange request table -->
                <h3>Requests For Exchange</h3>
<br>
    <!-- Search Bar -->
    ...
    <table class="borrow-book-list">
        <thead>
            <tr>
               
                <th>Name</th>
                <th>Genre</th>
                <th>Inexchange For</th>
                <th>Contact</th>
        ...
        <tbody>
            <?php $reqs = exchangeReq($_SESSION['user_id'], $conn); ?>
            ...
            <?php if (!empty($reqs)): ?>
                <?php foreach ($reqs as $req): ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($req['requester_title']); ?></td>
                        <td><?php echo htmlspecialchars($req['genre']); ?></td>
                        <td><?php echo htmlspecialchars($req['available_title']); ?></td>
                        <td><?php echo htmlspecialchars($req['phone_number']) ?></td>
                        <td><a href="<?php echo htmlspecialchars($req['book_condition']); ?>" target="_blank" rel="noopener noreferrer">View</a></td>
                        <form method="POST">
                            <td><button value="<?php echo htmlspecialchars($req['req_id']); ?>" name="accept">Accept</button></td>
                            <td><button value="<?php echo htmlspecialchars($req['req_id']); ?>" name="decline">Decline</button></td>
                        </form>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
    ...
    <script>
        document.getElementById('searchInput').addEventListener('keyup', function() {
            ...
            var tableRows = document.querySelectorAll('.borrow-book-list tbody tr');
...
<!-- Bootstrap JS -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js" integrity="sha384-7qlv8NYDnT2aOT99Upevmmtf+LOzX50mVCr5ne1NMD7/uVsOKd94hFG3DFQBjLc9" crossorigin="anonymous"></script>
