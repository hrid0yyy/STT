                        ...
                        <div class="reviews-section">
                            <div style="display: flex;justify-content: space-between;align-items: flex-start;">
                                <div style="display: flex; flex-direction: column;width:70%">
                                    <h1>Reviews</h1>
                                    <div style="width:70%; ">
                                        <div class="reviews-stats" style="display: flex; justify-content: space-between;align-items: center; gap:2rem; ">
                                            <div>
                                                <p>Total Reviews</p>
                                                <h2>10.0K</h2>
                                            </div>
                                            <div>
                                                ...
                                                <div style="display: flex;justify-content:center ;align-items:center;">
                                                    <h2>4.0</h2>
                                                    <div class="stars" style="font-size: 2rem;">★★★★☆</div> 
                                                </div>
                            ...
                            <div>
                                <span style="border:1px solid #cac3c3;padding:0.25rem;border-radius:0.15rem; margin-bottom: 1rem;">March 2021 - February 2022</span>
                            ...
                            <div class="reviews-list">
                                ...
                                <div class="review-item">
                                    <img src="image/dashboard/dp1.png" alt="Reviewer Avatar">
                                    <div class="review-content">
                                        <div class="review-header">Emon Ali</div>
                                        <div class="review-subtext">Book: 1984</div>
                                        <div class="stars">★★★★</div> 
                                        <span class="review-date"> - 7-7-2024</span>
                                        <p class="review-text">Delivery deri te dishen bhai. Abar boi er moddhe abod tabol likhao ase. Tao 4 star dilam.</p>
                                    </div>
                                </div>
                        
                                <!-- Review 2 -->
                                <div class="review-item">
                                    <img src="image/dashboard/luffy san.jpg" alt="Reviewer Avatar">
                                    <div class="review-content">
                                        <div class="review-header">Sheikh Mujib</div>
                                        <div class="review-subtext">Book: বাংলার শীর্ষ বই</div>
                                        <div class="stars">★☆☆☆☆</div> 
                                        <span class="review-date"> - 15-8-2024</span>
                                        <p class="review-text">Delivery te time moto dishen, quality o bhalo kintu lekha gula bhalo lage nai bhai. <span class="green-text">BTW AMAR NAME DEVDAS CHOKROBORTI</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
