                    ...
                    <section class="my-account-settings-container">
                        <div class="upload-container">
                            ...
                            <div class="upload-div" id="uploadDiv">
                              <img id="previewImage" src="image/dashboard/dp2.jfif" alt="Default Image">
                            ...
                            <form action="#" method="POST">
                                <div class="inputs">
                                    <div class="input-block">
                                        ...
                                        <div class="input-field">
                                            <div class="input-field-box">
                                                <input type="text" name="fname" placeholder="Charles">
                                    ...
                                    <div class="input-block">
                                        ...
                                        <div class="input-field">
                                            <div class="input-field-box">
                                                <input type="text" name="lname" placeholder="Leclrec">
                                                <img src="image/icon/icn2.png" alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="inputs">
                                    <div class="input-block">
                                        <div class="input-titles">
                                            ...
                                            <div class="edit-btn">
                                                <span><img src="image/icon/icn3.png" alt=""></span>
                                                <span class="field-title" style="color:#02D802;font-size: 15px;
                                                font-style: normal;
                                                font-weight: 700;">Verified</span>
                                            </div>
                                        </div>
                                        <div class="input-field">
                                            <div class="input-field-box">
                                                <input type="email" name="email" placeholder="Charles@tiringbiring.com">
                                    ...
                                    <div class="input-block">
                                        ...
                                        <div class="input-field">
                                            <div class="input-field-box">
                                                <input type="text" name="phnum" placeholder="+8801645194634">
                                ...
                                <div class="inputs">
                                    <div class="input-block">
                                        ...
                                        <div class="input-field">
                                            <div class="input-field-box">
                                                <input type="date" name="dob" placeholder="19/9/12">
                                    ...
                                    <div class="input-block">
                                        ...
                                        <div class="input-field">
                                            <div class="input-field-box">
                                                <select id="options" name="options"style="width: 345px; height: 45px; font-size: 16px; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">
                                                    <option value="option1">Gopalganj</option>
                                                    <option value="option2">Cumilla</option>
                                                    <option value="option3">Noyakhali</option>
                                                    <option value="option4">Barishal</option>
                                                  </select>
                                ...
                                <p style="font-size: 14px;margin-top: 3.5625rem;">BIO</p>
                                <textarea name="" id="" rows="5" style="width: 100%; height:9.3125rem;padding:1.25rem;border:none;">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam explicabo beatae necessitatibus eaque eligendi dignissimos nostrum ipsam voluptate dicta Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae consectetur obcaecati debitis porro, quisquam dist</textarea>
                                <div class="btn-blk">
                                    <button class="btns">Save All Changes</button>
                                </div>
