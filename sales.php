...
<head>
    ...
    <title>Inventory | Shelf To Tales</title>
    ...
    <link rel="stylesheet" href="css/exchange-books-reader.css">
    <link rel="stylesheet" href="css/image-search-reader.css">
                        ...
                        <div class="tabs">
                            <div class="tab-divs ">
                                <a href="account-shop-owner.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                   ...
                                   <span class="tab-title">My Account</span> </a>
                            </div>
                            <div class="tab-divs">
                            ...
                            <div class="tab-divs ">
                                <a href="shop-borrow.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  ...
                                  </svg><span class="tab-title">Borrow Request</span> </a>
                            </div>
                            <div class="tab-divs ">
                                <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path d="M5.01997 4.35356C5.10829 4.25877 5.15637 4.13341 5.15408 4.00387C5.1518 3.87434 5.09932 3.75075 5.00771 3.65914C4.91611 3.56753 4.79252 3.51506 4.66298 3.51277C4.53345 3.51049 4.40808 3.55857 4.3133 3.64689L2.97997 4.98022C2.88633 5.07397 2.83374 5.20106 2.83374 5.33356C2.83374 5.46606 2.88633 5.59314 2.97997 5.68689L4.3133 7.02022C4.35907 7.06935 4.41428 7.10875 4.47561 7.13608C4.53694 7.16341 4.60315 7.1781 4.67029 7.17928C4.73742 7.18047 4.80411 7.16812 4.86637 7.14297C4.92862 7.11782 4.98518 7.08039 5.03266 7.03292C5.08014 6.98544 5.11757 6.92888 5.14272 6.86662C5.16786 6.80436 5.18021 6.73768 5.17903 6.67054C5.17784 6.60341 5.16315 6.5372 5.13582 6.47586C5.10849 6.41453 5.06909 6.35933 5.01997 6.31356L4.53997 5.83356H11.3333C11.4659 5.83356 11.5931 5.78088 11.6869 5.68711C11.7806 5.59334 11.8333 5.46616 11.8333 5.33356C11.8333 5.20095 11.7806 5.07377 11.6869 4.98C11.5931 4.88623 11.4659 4.83356 11.3333 4.83356H4.53997L5.01997 4.35356ZM10.98 8.98022C10.8863 9.07397 10.8337 9.20106 10.8337 9.33356C10.8337 9.46606 10.8863 9.59314 10.98 9.68689L11.46 10.1669H4.66663C4.53403 10.1669 4.40685 10.2196 4.31308 10.3133C4.21931 10.4071 4.16663 10.5343 4.16663 10.6669C4.16663 10.7995 4.21931 10.9267 4.31308 11.0204C4.40685 11.1142 4.53403 11.1669 4.66663 11.1669H11.46L10.98 11.6469C10.9308 11.6927 10.8914 11.7479 10.8641 11.8092C10.8368 11.8705 10.8221 11.9367 10.8209 12.0039C10.8197 12.071 10.8321 12.1377 10.8572 12.2C10.8824 12.2622 10.9198 12.3188 10.9673 12.3662C11.0148 12.4137 11.0713 12.4512 11.1336 12.4763C11.1958 12.5015 11.2625 12.5138 11.3296 12.5126C11.3968 12.5114 11.463 12.4967 11.5243 12.4694C11.5857 12.4421 11.6409 12.4027 11.6866 12.3536L13.02 11.0202C13.1136 10.9265 13.1662 10.7994 13.1662 10.6669C13.1662 10.5344 13.1136 10.4073 13.02 10.3136L11.6866 8.98022C11.5929 8.88659 11.4658 8.834 11.3333 8.834C11.2008 8.834 11.0737 8.88659 10.98 8.98022Z" fill="black"/>
                    ...
                    <section class="rightside-container">
                        <div class="heading-container">
                            <div class="heading-area">
                                <p style="line-height: 1.35rem;">
                                    <span style="font-size: 18px; font-weight: bolder;">Sale List</span> <br>Manage your sales
                                </p>
                            </div>
...
<form id="filterForm">
 ...
 <input type="date" id="startDate" placeholder="Start Date">
    ...
    <option value="">All</option> <!-- No filter (default) -->
...
<style>
    /* Style the form container to be inline */
    .action form {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    .form-select {
        ...
        border-radius: 4px;
        margin-right: 10px; /* Space between the select and the button */
    }
    ...
    .btn {
        ...
        border: none;
        border-radius: 4px;
        background-color: #62ab00; /* Primary color */
        color: white;
        cursor: pointer;
    }
    ...
    /* Ensure the whole form (dropdown + button) fits nicely inside the table cell */
    td.action {
        padding: 10px;
    }
        /* General styling for the table */
        .product-table {
        width: 100%; /* Make sure the table adapts to its container */
        margin: 20px 0; /* Margin between the table and surrounding content */
    ...
    #product-table td {
        ...
        border-bottom: 1px solid #ddd; /* Light border for clarity */
        text-align: left;
    }

    /* Container to align the dropdown and button side by side */
    .action-container {
        display: flex;
        align-items: center; /* Vertically align items */
        justify-content: space-between; /* Create space between elements */
        gap: 10px; /* Add some space between dropdown and button */
    }
    ...
    .btn:hover {
        background-color: white;
        color: #62ab00;
        border: 1px solid #62ab00; /* Add border when hovering */
    }
...
<div class="product-table">
    <table id="product-table">
        ...
        <tbody id="productTableBody">
            ...
            $mysqli = new mysqli("localhost", "root", "", "stt_db");
            $sql = "SELECT * from billing 
                    join purchase on billing.purchase_id = purchase.purchase_id
                    join shopowners on purchase.shop_owner_id = shopowners.shop_owner_id
                    join books on purchase.book_id = books.book_id
                    where shopowners.shop_owner_id = ?
            ...
            if ($items) { 
                ...
                <tr>
                    <td class="product"><?php echo $item['title']; ?></td>
                    <td class="quantity"><?php echo $item['quantity']; ?></td>
                    <td class="buyer"><?php echo $item['first_name']; ?></td>
                    <td class="address"><?php echo $item['address']; ?>, <?php echo $item['town']; ?></td>
                    <td class="contact"><?php echo $item['phone_number']; ?> <br> <?php echo $item['email']; ?></td>
                    <td class="date"><?php echo $item['purchase_date']; ?></td>
                    <td class="date"><?php echo $item['status']; ?></td>
                    <td class="status">
                        <form method="POST">
                            <div class="action-container"> <!-- Flexbox container -->
                                ...
                                <input type="hidden" name="billing_id" value="<?php echo $item['billing_id']; ?>">
    ...
    $sql = "UPDATE billing SET status = ? WHERE billing_id = ?";
...
function filterTable() {
    ...
    const statusFilter = document.getElementById("statusFilter").value.toLowerCase(); // Get the selected status filter
    ...
    for (let i = 0; i < rows.length; i++) {
        const product = rows[i].getElementsByClassName("product")[0].textContent.toLowerCase();
        const buyer = rows[i].getElementsByClassName("buyer")[0].textContent.toLowerCase();
        const contact = rows[i].getElementsByClassName("contact")[0].textContent.toLowerCase();
        const address = rows[i].getElementsByClassName("address")[0].textContent.toLowerCase();
        const date = rows[i].getElementsByClassName("date")[0].textContent;

        // Retrieve the selected value from the status dropdown in the row
        const statusDropdown = rows[i].querySelector("select[name='status']");
        const status = statusDropdown ? statusDropdown.value.toLowerCase() : "";

        // Check if the row matches the search term
        let matchesSearch = product.includes(searchInput) || buyer.includes(searchInput) || contact.includes(searchInput) || address.includes(searchInput);

        // Check if the row falls within the date range
                    ...
                    <div class="modal" id="addProductModal">
                        <div class="modal-content">
                            ...
                            <form id="addProductForm" method="POST">
                                <label>What kind of item would you like to add?</label><br>
                              
                    
                                <label>Book Name:</label><br>
                                <input type="text" name="book_name" class="custom-input" required><br><br>
                    
                                <label>Quantity:</label><br>
                                <input type="text" name="quantity" class="custom-input" required><br><br>
                    
                           
                                <label>Quality:</label><br>
                                <select name="quality" class="custom-input" required>
                                    <option value="White Print">White Print</option>
                                    <option value="Yellow Print">Yellow Print</option>
                                ...
                                <label>Price (in Taka):</label><br>
                                <input type="number" name="price" step="0.01" class="custom-input" placeholder="Enter price" required><br><br>
                    
                                <div class="save-cancel-btn">
                                    <div class="save-btn custom-btn">
                                        <button type="submit" name = "addItems">Save</button>
                                    </div>
