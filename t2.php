...
<body>
    ...
    <form action="edit_advertisement.php?id=<?php echo htmlspecialchars($ad_id); ?>" method="POST">
        ...
        <input type="number" name="discount" min="0" max="100" value="<?php echo htmlspecialchars($ad_row['discount_percentage']); ?>" required>

        <label for="start_date">Start Date:</label>
        <input type="datetime-local" name="start_date" value="<?php echo htmlspecialchars($ad_row['advertising_start_date']); ?>" required>

        <label for="end_date">End Date:</label>
        <input type="datetime-local" name="end_date" value="<?php echo htmlspecialchars($ad_row['advertising_end_date']); ?>" required>
