								...
								<div class="col-lg-7 mb--20">
									...
									<div id="billing-form" class="mb-40">
										...
										<div class="row">
											...
											<button class="place-order w-100" name="order">Place order</button>
											</form>
									...
									<div class="row">
										...
										<div class="col-12">
											<div class="checkout-cart-total">
												...
												<ul>
														<?php $total = 0; if (!empty($cart_items)) { ?>
													
                                 						<?php foreach ($cart_items as $item) {  $total += $item['total_price']?>
													<li><span class="left"><?php echo $item['title']; ?> X <?php echo $item['amount']; ?></span> <span
															class="right"><?php echo $item['total_price']; ?></span></li>
															<?php } ?>
                                    <?php } ?>
												</ul>
												<p>Sub Total <span><?php echo $total; ?></span></p>
												<p>Shipping Fee <span>100.00</span></p>
												<h4>Grand Total <span><?php  echo $total + 100; ?></span></h4>
