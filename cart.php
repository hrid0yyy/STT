								...
								<div class="cart-table table-responsive mb--40">
									<table class="table">
										...
										<tbody>
											...
											<td class="pro-remove">
											<form method="GET" >
												<input type="hidden" name="delete_cart_id" value="<?php echo $item['cart_id']; ?>"> <!-- Replace 123 with the actual cart item ID -->
												...
												<td class="pro-thumbnail"><a href="#"><img
															src="image/book-cover/<?php echo $item['bookcover']; ?>" alt="Product"></a></td>
												...
												<td class="pro-subtotal"><span><?php echo $item['total_price']. " TK"; ?></span></td>
											</tr>
										 <?php  }  ?>
										 <?php } ?>
