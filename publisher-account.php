            ...
            <section class="account-context">
                <div class="inner-account-context">
                        ...
                        <div class="tabs">
                            <div class="tab-divs active">
                                <a href="publisher-account.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  ...
                                  </svg> <span class="tab-title" style="color: white;">My Account</span> </a>
                            </div>
                            <div class="tab-divs ">
                            ...
                            <div class="tab-divs ">
                                <a href="publisher-publication-request.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  ...
                                  </svg><span class="tab-title">PUBLICATION REQUEST</span> </a>
                            </div>
                            <div class="tab-divs ">
                    ...
                    <?php 
                       ...
                       include 'backend/publisher/account.php'; 
                       $account = getPublisherInfo($_SESSION['user_id']);
                      ?>
                    <section class="my-account-settings-container">
                        <div class="upload-container">
                            ...
                            <div class="upload-div" id="uploadDiv">
                              <img id="previewImage" src="image/dashboard/<?php echo $account['profile_pic'] ?>" alt="Default Image">
                            ...
                            <form  method="POST">
                                <div class="inputs">
                                    <div class="input-block">
                                        <div class="input-titles">
                                            <span class="input-title">Publisher Name</span>
                                            <div class="edit-btn">
                                        ...
                                        <div class="input-field">
                                            <div class="input-field-box">
                                                <input type="text" name="publisher_name" value="<?php echo $account['publisher_name'] ?>" placeholder="<?php echo $account['publisher_name'] ?>">
                                    ...
                                    <div class="input-block">
                                        <div class="input-titles">
                                            <span class="input-title">Website Link</span>
                                            <div class="edit-btn">
                                                <span><img src="image/icon/icn1.png" alt=""></span>
                                                <span class="field-title">Edit</span>
                                            </div>
                                        ...
                                        <div class="input-field">
                                            <div class="input-field-box">
                                                <input type="text" name="website" value="<?php echo $account['website'] ?>" placeholder="<?php echo $account['website'] ?>">
                                                <img src="image/icon/icn2.png" alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="inputs">
                                    <div class="input-block">
                                        ...
                                        <div class="input-field">
                                            <div class="input-field-box">
                                                <input type="email" name="email" value="<?php echo $account['email'] ?>" placeholder="<?php echo $account['email'] ?>">
                                    ...
                                    <div class="input-block">
                                        ...
                                        <div class="input-field">
                                            <div class="input-field-box">
                                                <input type="text" name="phone_number" value="<?php echo $account['phone_number'] ?>" placeholder="<?php echo $account['phone_number'] ?>">
                                ...
                                <div class="inputs">
                                    <div class="input-block">
                                        <div class="input-titles">
                                            <span class="input-title">Established Date</span>
                                            <div class="edit-btn">
                                                <span><img src="image/icon/icn1.png" alt=""></span>
                                                <span class="field-title">Edit</span>
                                            </div>
                                        ...
                                        <div class="input-field">
                                            <div class="input-field-box">
                                                <input type="date" name="established_date" value="<?php echo $account['established_date'] ?>" placeholder="<?php echo $account['established_date'] ?>">
                                    ...
                                    <div class="input-block">
                                        ...
                                        <div class="input-field">
                                            <div class="input-field-box">
                                                <input type="text" name="address" value="<?php echo $account['address'] ?>" placeholder="<?php echo $account['address'] ?>">
                                                <img src="image/icon/icn2.png" alt="">
                                            </div>
                                        </div>
                                    </div>
                               ...
                               <br> <br>
                                <div class="btn-blk">
                                    <button class="btns" name = "update_publisher_profile">Save All Changes</button>
                                </div>
