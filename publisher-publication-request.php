...
<?php
            if(isset($_POST['response'])){
                    ...
                    $sql = "UPDATE publication_request SET status = ? WHERE request_id = ?";
...
$query = "SELECT * from publication_request join publishers on publication_request.publisher_id = publishers.publisher_id
 join writers on writers.writer_id = publication_request.writer_id
 WHERE publishers.publisher_id = $publisher_id order by request_date desc ";
                                ...
                                <div class="cart-widget">
                                    <!-- <div class="login-block">
                                        <div class="login-block">
                                            ...
                                            <div class="user-name">
                                                <span style="font-weight: 600;">My White</span>
                                            </div>
                                        </div>
                                    </div> -->
            ...
            <section class="account-context">
                <div class="inner-account-context">
                    <div class="tablist">
                        ...
                        <div class="tabs">
                        <div class="tab-divs ">
                                <a href="publisher-account.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            ...
                            <div class="tab-divs ">
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  ...
                                  </svg><span class="tab-title">BOOK LIST</span> </a>
                            </div>
                            <div class="tab-divs active">
                                <a href="publisher-publication-request.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  ...
                                  </svg><span class="tab-title " style="color: white;">PUBLICATION REQUEST</span> </a>
                            </div>
                            <div class="tab-divs ">
                                <a href="publisher-writer-list.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  ...
                                  </svg><span class="tab-title">WRITERS</span> </a>
                            </div>
                            <div class="tab-divs ">
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            ...
                            <div class="tab-divs ">
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path d="M2.66663 13.3332V2.6665H8.01329V3.33317H3.33329V12.6665H8.01329V13.3332H2.66663ZM10.9746 10.3592L10.5066 9.87917L12.0526 8.33317H6.12796V7.6665H12.0526L10.506 6.11984L10.974 5.64117L13.3333 7.99984L10.9746 10.3592Z" fill="black"/>
                                  </svg><span class="tab-title">LOGOUT</span> </a>
                            </div>
...
<style>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td> <?php if($request['status']=="pending"){ ?>
            ...
            <td> <form method="POST" >
                    ...
                    <button type="submit" name="response" style="background-color: #62ab00; color: white; padding: 2px 5px; border: none; border-radius: 5px; cursor: pointer; font-size: 12px;" class="action-button">
    Update
</button>
