                ...
                <div class="inner-account-context">
                    ...
                    <section class="rightside-container">
                        ...
                        <table class="borrow-book-list">
                            ...
                            <tr>
                                <td>KAFKA</td>
                                <td>kafa221@gmail.com</td>
                                <td>234325435</td>
                                <td> <button style=""><img src="image/icon/user1.png" alt="" style="width:16px;height:16px">  </td>
                            </tr>
                            <!-- <tr>
                                <td><img src="image/products/p-1.png" alt="" style="width: 2.9375rem;"></td>
                                <td>Kacher Kornel</td>
                                <td>Mahbub</td>
                                <td>6 Days</td>
                            </tr> -->
