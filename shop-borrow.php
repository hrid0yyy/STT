...
<?php
  session_start();
  include 'backend/shopowner/borrow.php';
  include 'backend/shopowner/myaccount.php';
  include 'backend/shopowner/logout.php';
  $details = account_details($_SESSION['user_id']);
  $borrowed_books = get_borrowed_books($_SESSION['user_id']);
...
<body>
                    ...
                    <div class="tablist">
                        <div class="profile">
                            ...
                            <div class="name-and-loation">
                                <p><?php echo $details['shop_name']; ?></p>
                                <p><?php echo $details['city']; ?></p>
                            </div>
                        ...
                        <div class="tabs">
                            ...
                            <div class="tab-divs active">
                                <a href="inventory.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  ...
                                  </svg><span class="tab-title">Inventory</span> </a>
                            </div>
                            <div class="tab-divs">
                                    <a href="sales.php">
                            ...
                            <div class="tab-divs ">
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  ...
                                  </svg><span class="tab-title">Borrow Requests</span> </a>
                            </div>
                    ...
                    <section class="rightside-container">
                        <div class="heading-container">
                            <div class="heading-area">
                                <p style="line-height: 1.35rem;">
                                    <span style="font-size: 18px; font-weight: bolder;">Borrowed Books Tracking</span> <br>Manage borrowed books
                                </p>
                            </div>
                        ...
                        <div class="borrowed-books-table">
                            <table id="borrowed-books-table">
                                ...
                                <!-- Existing borrowed records will be listed here -->
                                <?php if(!empty($borrowed_books)){ foreach ($borrowed_books as $bb){ ?>
                                    <tr> 
                                        <td><?php echo $bb['reader_id'] ?></td>
                                        <td><?php echo $bb['title'] ?></td>
                                        <td><?php echo $bb['borrow_date'] ?></td>
                                        <form method="POST">
                                        <td><button name="return" value="<?php echo $bb['borrowing_id'] ?>">Returned</button></td>
                                        </form>
                                    </tr>
                                    <?php  } } ?>
                            </table>
                    ...
                    <div class="modal" id="addProductModal">
                        ...
                        <div class="modal-content">
                            ...
                            <form id="addProductForm" onsubmit="saveProduct(event)">
                                ...
                                <input type="text" name="available_copies" class="custom-input" required><br><br>
  ...
  function handleFileUpload(event) {
    ...
    if (file) {
      ...
      // You can now handle the file amodaladd s needed (e.g., upload to server)
    }
  }
