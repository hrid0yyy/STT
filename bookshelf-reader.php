...
<head>
    ...
    <title>Virtual Bookshelf | Shelf To Tales</title>
    ...
    <link rel="stylesheet" href="css/bookshelf-reader.css">
    <style>
        .profile-pic{
            width: 50px;
            height: 50px;
...
<!-- image search -->
            ...
            <section class="account-context">
                <div class="inner-account-context">
                    ...
                    <section class="rightside-container">
                        <nav>
                            <button onclick="showTable(1),changeColor(this)"   class="nav-btn">All</button>
                            <button onclick="showTable(2),changeColor(this)"   class="nav-btn">Want To Read</button>
                            <button onclick="showTable(3),changeColor(this)"   class="nav-btn">Currently Reading</button>
                            <button onclick="showTable(4),changeColor(this)"   class="nav-btn">Read</button>
                        </nav>
                        
                        <table class="borrow-book-list" id="table1">
                            <tr>
                                <td>Cover</td>
                                <td>Name</td>
                                <td>Status</td>
                        ...
                        <table class="borrow-book-list" id="table2">
                            <tr>
                                <td>Cover</td>
                                <td>Name</td>
                                <td>Status</td>
                        ...
                        <table class="borrow-book-list" id="table3">
                            <tr>
                                <td>Cover</td>
                                <td>Name</td>
                                <td>Status</td>
                        ...
                        <table class="borrow-book-list" id="table4">
                            <tr>
                                <td>Cover</td>
                                <td>Name</td>
                                <td>Status</td>
    ...
    <script>
        function showTable(tableNumber) {
            ...
            tables.forEach(table => {
                table.classList.remove('active-btn');
            });

            // Show the selected table
            const table = document.getElementById(`table${tableNumber}`);
            table.classList.add('active-btn');
    ...
    // Apply the new color to the currently clicked button
    ...
    lastClickedButton = button;
        ...
        var currentRow; // Store the current row being edited

        // When the user clicks on the "Edit" button, open the modal and fill in the values
        function editRow(button) {
            modal.style.display = "flex"; // Show the modal
            currentRow = button.parentElement.parentElement; // Get the row to edit

            // Fill the modal with the current row's values
            document.getElementById("bookName").value = currentRow.cells[1].innerHTML;
            document.getElementById("bookStatus").value = currentRow.cells[2].innerHTML;
            document.getElementById("startDate").value = currentRow.cells[3].innerHTML;
            document.getElementById("endDate").value = currentRow.cells[4].innerHTML;
        }
        ...
        // Function to save the changes back to the table
        function saveChanges() {
            // Update the row with new values from the modal
            currentRow.cells[1].innerHTML = document.getElementById("bookName").value;
            currentRow.cells[2].innerHTML = document.getElementById("bookStatus").value;
            currentRow.cells[3].innerHTML = document.getElementById("startDate").value;
            currentRow.cells[4].innerHTML = document.getElementById("endDate").value;
